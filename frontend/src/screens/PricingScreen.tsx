      ...
      <div className="mx-auto max-w-[460px]">
        ...
        <div className="mt-7 grid gap-4">
          <Panel className="p-5">
            ...
            <div className="text-[24px] font-black text-[#6c9e36]">
              {lang === "ur" ? "ہمیشہ مفت" : "Free forever"}
            </div>
            <ul className="mt-4 space-y-2 text-[14px] leading-7 text-[#5f523f]">
              {[
                lang === "ur"
                  ? "کھانا، پانی اور ورزش لاگ"
                  : "Food, water, and workout logging",
                lang === "ur"
                  ? "باغیچہ جو کبھی نہیں گرتا"
                  : "A garden that never regresses",
