...
export const QUICK_ACTIONS: QuickAction[] = [
  { id: 'diet_plan', en: 'Get my diet plan', ur: 'میرا کھانے کا پلان', countsAgainstChatCap: false },
  { id: 'workout_plan', en: 'Get my workout plan', ur: 'میری ورزش کا پلان', countsAgainstChatCap: false },
...
export function quickActionPrompt(id: QuickActionId, lang: 'en' | 'ur'): string {
