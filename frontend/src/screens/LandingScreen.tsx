    ...
    <div className="min-h-screen pb-16">
      <div className="px-5 pt-4">
        ...
        <Panel tone="warm" className="mt-7 p-4">
          ...
          <div className="grid gap-3">
            <div className="flex items-center gap-3 rounded-[22px] bg-white/60 p-3.5">
              ...
              <div>
                <div className="font-bold text-[#2c2418]">
                  {t("step1", lang)}
                </div>
                <div className="mt-0.5 text-[13px] text-[#6e5d4a]">
                  {t("step1sub", lang)}
                </div>
              </div>
            </div>
        ...
        <div className="mt-7 grid gap-3 sm:grid-cols-2">
          <Panel className="p-4">
            <div className="text-[13px] font-extrabold text-[#d96d20]">
              {t("freePlan", lang)}
            </div>
            <div className="mt-1 text-[22px] font-black text-[#241f15]">
              {lang === "ur" ? "مفت" : "Free"}
            </div>
          ...
          <Panel className="p-4">
            <div className="text-[13px] font-extrabold text-[#e3ab25]">
              {t("premiumPlan", lang)}
            </div>
            <div className="mt-1 text-[22px] font-black text-[#241f15]">
              PKR 299
