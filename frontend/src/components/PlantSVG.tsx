...
const Cactus2 = () => (
  <g>
    ...
    {/* Left arm */}
    <path
      d="M42,36 C33,36 27,44 27,50 L33,50 C33,46 40,44 42,42Z"
      fill="#5A8830"
    />
    ...
    {/* Right arm */}
    <path
      d="M58,44 C67,44 73,52 73,58 L67,58 C67,54 60,52 58,50Z"
      fill="#5A8830"
    />
...
const Cactus3 = () => (
  <g>
    ...
    {/* Left arm lower */}
    <path
      d="M41,40 C30,40 22,50 22,56 L28,56 C28,52 38,48 41,46Z"
      fill="#5A8830"
    />
    ...
    {/* Right arm upper */}
    <path
      d="M59,26 C70,26 78,36 78,42 L72,42 C72,38 62,34 59,32Z"
      fill="#5A8830"
    />
...
const Sunflower0 = () => (
  <g>
    ...
    <path
      d="M50,58 C42,52 38,56 40,62 C44,64 48,61 50,58Z"
      fill="none"
      stroke="#628830"
      strokeWidth="0.6"
    />
    <path
      d="M50,58 C58,52 62,56 60,62 C56,64 52,61 50,58Z"
      fill="none"
      stroke="#628830"
      strokeWidth="0.6"
    />
...
const Bell = ({ cx, cy, r = 1 }: { cx: number; cy: number; r?: number }) => (
  <g transform={`translate(${cx}, ${cy}) scale(${r})`}>
    <path
      d="M0,-10 C-5,-8 -7,-2 -7,4 C-7,9 -4,12 0,13 C4,12 7,9 7,4 C7,-2 5,-8 0,-10Z"
      fill="#5E8AC8"
    />
    <path
      d="M0,-10 C-5,-8 -7,-2 -7,4 C-7,9 -4,12 0,13 C4,12 7,9 7,4 C7,-2 5,-8 0,-10Z"
...
const BambooStalk = ({
  ...
  <g>
    ...
    {/* leaves */}
    <path
      d={`M${x},${74 - h + 4} C${x + leafDir * 20},${74 - h - 8} ${x + leafDir * 22},${74 - h + 6} ${x},${74 - h + 12}Z`}
      fill="#90C060"
      opacity="0.9"
    />
    <path
      d={`M${x},${74 - h * 0.5} C${x + leafDir * 18},${74 - h * 0.5 - 10} ${x + leafDir * 20},${74 - h * 0.5 + 4} ${x},${74 - h * 0.5 + 10}Z`}
      fill="#90C060"
      opacity="0.8"
    />
  </g>
...
const Succulent1 = () => (
  <g>
    {[0, 72, 144, 216, 288].map((a, i) => (
      <Leaf key={i} angle={a} r={12} size={8} />
    ))}
...
const Succulent2 = () => (
  <g>
    {[0, 45, 90, 135, 180, 225, 270, 315].map((a, i) => (
      <Leaf key={i} angle={a} r={18} size={10} />
    ))}
    {[22.5, 67.5, 112.5, 157.5, 202.5, 247.5].map((a, i) => (
      <Leaf key={i + 8} angle={a} r={9} size={7} />
    ))}
...
const Succulent3 = () => (
  <g>
    {[0, 36, 72, 108, 144, 180, 216, 252, 288, 324].map((a, i) => (
      <Leaf key={i} angle={a} r={22} size={12} />
    ))}
    {[18, 54, 90, 126, 162, 198, 234, 270].map((a, i) => (
      <Leaf key={i + 10} angle={a} r={13} size={9} />
    ))}
    {[0, 60, 120, 180, 240, 300].map((a, i) => (
      <Leaf key={i + 18} angle={a} r={7} size={6} />
    ))}
...
export default function PlantSVG({
  ...
  return (
    <svg
      ...
      className={className}
      style={{
        filter: dormant ? "saturate(0.45) brightness(1.05)" : undefined,
      ...
      {dormant && (
        <g>
          <circle
            ...
            strokeWidth="1"
          />
          <text x="76" y="18" textAnchor="middle" fontSize="12">
            🌙
          </text>
        </g>
      )}
